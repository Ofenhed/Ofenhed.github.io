...
pub fn Unremarkable() -> BlogEntry<Children> {
    ...
    <li>
    "You have integration with other cloud services, but only through your own cloud service. This means that if I want integration with Drive/Dropbox/OneDrive, then I have to give "<b>"YOU"</b>" (not my device, but you as service providers) access to "<b>"MY ENTIRE ACCOUNTS"</b>"."
    </li>
    <li>
    ...
    <li>
    "Only a Chrome plugin. Seriously? Take a look at " <a href="https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Build_a_cross_browser_extension">"Mozilla's guide to building a cross browser extension"</a>"."
    </li>
    <li>
    ...
    <li>
    "You should not run everything as root. This is pretty much lesson one in security, which makes me think that I don't want any sensitive data in your cloud."
    </li>
    </ul>
        };
    BlogEntry {
