    ...
    fn view(_this: Self) -> AnyView {
        ...
        view! {
            ...
            <section>
                ...
                " models to recall (near-verbatim) 95.8% of the first Harry Potter book and 95.5% of 1984. This doesn't prove lack of intelligence, it just proves that the data is there."
            </section>
            <section>
                ...
                <ul>
                    <li>
                        <b>"Volume"</b>
                        ": Pretty much all text humanity has ever written has been used to optimize these models."
                    </li>
                    <li>
                        <b>"Huge context windows"</b>
                        ": The generated text is put together based on a ridiculous number of parameters."
                    </li>
                    <li>
                        <b>
                            "Idealization/"
                        ...
                        {llm}
                        "s, I would expect that you want there to be a meaning to those conversations."
                    </li>
                    <li>
                        <b>"Authority"</b>
                    ...
                    <li>
                        ...
                        <Footnote>
                            ...
                            ". They warn that the models might at any time start improving themselves, and take over the world. "
                            <em>
                    ...
                    <li>
                        ...
                        {ai}
                        " is built to uphold the illusion."
                    </li>
                </ul>
            </section>
            <section>
                ...
                <ul class="lies">
                    ...
                    <li>
                        "You could argue that \"reasoning models\" are "<em>"reasoning"</em>
                    ...
                    <li>
                        ...
                        {llm}
                        "s do. What's so cool about the technology is that the generated text often matches reality."
                    </li>
                </ul>
            </section>
            <section>
                ...
                {llm}
                "s are capable of, and even what they will be capable of in the future."
            </section>
            //<section>
